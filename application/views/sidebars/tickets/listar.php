<div class="col-xs-6 col-sm-3 sidebar-offcanvas affix-top" id="sidebar" role="navigation">
	<div class="list-group">
		...
		<a href="#" class="list-group-item active">Listar todos los tickets</a>
		<a href="<?=$this->config->base_url()?>tickets/nuevo" class="list-group-item">Nuevo ticket</a>
		<a href="#" class="list-group-item disabled">Editar ticket</a>
		<a href="#" class="list-group-item disabled">Eliminar ticket</a>
	</div>
	<div class="list-group">
	</div>
</div><!--/span-->
