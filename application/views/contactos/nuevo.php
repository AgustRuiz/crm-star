		...
		<div class="col-xs-12 col-sm-9">
			...
			<script>
				function addCorreo(){
					...
					var nuevaLinea = '<div class="form"><div class="col-md-7 padding0"><input type="text" class="form-control" id="txtEmail" name="txtEmail" placeholder="Correo electrónico" /></div><label class=" col-md-2"><input type="radio" name="radPrincipal" /> Principal</label><label class="col-md-2"><input type="checkbox" name="chkNoValido" /> No válido</label><div class="btn btn-default pull-right col-md-1" onclick="removeCorreo(this);"><span class="glyphicon glyphicon-minus-sign"></span></div><div>';
					divCorreos.innerHTML += nuevaLinea;
				}
