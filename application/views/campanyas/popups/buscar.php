...
<head>
	...
	<title>include_busqueda_campaña</title>
...
<body style="overflow:hidden;" onload="setHeightIframeElement();">
	<div id="contenido">
		<form class="form-vertical" role="form" method="post" accept-charset="utf-8" action="<?=$this->config->base_url()."index.php/campanyas/include_busqueda_campanya";?>">
		...
		<table class="table table-striped table-hover table-condensed">
			...
			<tbody id="contenedor">
				...
				<?php } } else { ?>
				<tr>
					<td colspan="6" class="text-center"><em>No hay resultados</em></td>
				</tr>
				<?php } ?>
			</tbody>
			<tfoot>	
